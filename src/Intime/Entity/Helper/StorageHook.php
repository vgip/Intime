...
/**
 * Hook storage property setter and getter
 * 
 * Example real methods:
 * 
 *     public function setId(StorageInterface $id = null) : void
 *     {
 *         $this->id = $id;
 *     }
 * 
 *     public function getId() : StorageInterface
 *     {
 *        return $this->id;
 *     }
 * 
...
class StorageHook implements StorageInterface
{
    private $data;
     ...
     */
    private function hookGetter(string $property, array $arguments)
    {
        $argumentCounter = count($arguments);
